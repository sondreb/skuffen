...
22. `e2e/specs/19-people-relations.spec.ts` — add sibling, both cards show it; filter by family; uncheck/reject a proposed relation writes nothing; delete person wipes that slug’s edges. Live AI hosts blocked.
